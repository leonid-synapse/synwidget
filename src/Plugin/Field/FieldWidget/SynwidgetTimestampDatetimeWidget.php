...
namespace Drupal\synwidget\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'synapse datetime timestamp' widget.
 *
 * @FieldWidget(
 *   id = "synwidget_datetime_timestamp",
 *   label = @Translation("Synapse Datetime Timestamp"),
 *   field_types = {
 *     "timestamp"
 *   }
 * )
 */
class SynwidgetTimestampDatetimeWidget extends WidgetBase {
